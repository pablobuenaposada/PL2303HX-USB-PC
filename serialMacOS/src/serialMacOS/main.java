...
public class main {
    ...
    public static void configPort(String usbPort,String appName) throws NoSuchPortException, PortInUseException, UnsupportedCommOperationException, IOException{
